...
#The results file can be obtained at http://www.football-data.co.uk/


fixtures<- read.csv("Data/Calendario.csv")
teams<- read.csv("Data/EquipasPortuguesas.csv")
results<- read.csv("Data/P1.csv") 
